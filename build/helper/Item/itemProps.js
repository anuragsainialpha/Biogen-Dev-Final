...
exports.mapItemDescription = exports.mapRemark = exports.mapItemClassification = exports.mapItemFeature = exports.mapRefnum = exports.mapHeader = void 0;
...
exports.mapItemClassification = (element, ItemClassification, type, gtmVersion, xmlNs, i, domain) => {
    ...
    return {
        ...
        path: [
            ...
            other_1.getTC(element, ItemClassification[remTransactionCodeIndex].path.replace('INDEX', i)),
            other_1.getXID(element, ItemClassification[fetIdIndex].path.replace('INDEX', i)),
        ],
        gtmVersion,
        xmlNs,
    };
