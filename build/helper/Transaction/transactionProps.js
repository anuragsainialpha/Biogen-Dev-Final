...
exports.mapTrxLineItemId = exports.mapDate = exports.mapInvolvedParty = exports.mapCurrency = exports.mapQuantity = exports.mapRemark = exports.mapRefnum = exports.mapHeader = void 0;
...
exports.mapQuantity = (element, Quantity, type, gtmVersion, xmlNs, i, prefix, domain) => {
...
exports.mapInvolvedParty = (element, InvolvedParty, type, gtmVersion, xmlNs, i, prefix, domain = '') => {
    ...
    return {
        ...
        path: [
            ...
            other_1.getDomainName(element, InvolvedParty[remDomainNameIndex].path.replace('INDEX', i)),
