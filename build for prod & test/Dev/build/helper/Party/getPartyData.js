...
exports.getUpdatedProp = exports.getPartyData = exports.getPartySchema = void 0;
...
function getRemarks(gtmData, Remark, gtmVersion, xmlNs, domain) {
    ...
    Remark = remarkQuals.map((e, i) => partyProps_1.mapRemark(e, Remark, 'Party : Remark', gtmVersion, xmlNs, i, domain));
    return Remark;
}
