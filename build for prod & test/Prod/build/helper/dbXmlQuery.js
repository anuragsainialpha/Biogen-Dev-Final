...
exports.getTransmissionStatus = (transmission, reProcess) => {
  ...
  where ('magic',${reProcess ? 'I_TRANSACTION_NO' : 'I_TRANSMISSION_NO'})
  
  in ( ('magic','${transmission.join("'),('magic','")}' ))
  
  </Statement>  
  </Query>  
</sql2xml>`;
};
exports.validateItemAndContact = ({ items, contacts }) => {
...
exports.getIncotermFromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
SELECT distinct INCO_TERM_GID as INCOTERM FROM INCO_TERM
</Statement></Query></sql2xml>`;
exports.getCountryCodeFromGtm = `<sql2xml><Query><RootName>GTM</RootName><Statement>
SELECT distinct COUNTRY_CODE3_XID || ' - ' || COUNTRY_NAME COUNTRY 
FROM COUNTRY_CODE
</Statement></Query></sql2xml>`;
exports.getAutoGenId = `<sql2xml><Query><RootName>GTM</RootName><Statement>
SELECT nvl((
